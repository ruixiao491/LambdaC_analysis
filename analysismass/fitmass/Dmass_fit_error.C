...
//this is for PbPb fit lambdaC 2015.
void Dmass_fit_error(){
...
TF1 *f3=new TF1("f3","[0]*TMath::Gaus(x,[1],[2])/(sqrt(2*3.14159)*[2])+pol2(3)",2.1,2.45);
...
h1->Fit("f3","","",2.104,2.35);//This line is used for wei's cut and Jian's cut with PV refit
