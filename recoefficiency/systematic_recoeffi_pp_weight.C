...
Int_t ptbins[5]={5,6,8,10,20};
Double_t dls[4]={2.6979993536749927,2.0553102716912526,1.9962837410042045,2.0567947541710949};
Double_t alpha[4]={0.21379631639014482,0.17856266296587384,0.17552951974295602,0.18578151058528442};
Double_t vertexpro[4]={0.26705336676903046,0.048977854761238913,0.045594948264545000,0.052311155858355128};
...
void systematic_recoeffi_pp_weight(){
...
//			  cout<<"pt"<<Dpt[icand]<<" dis"<<dls[ipt]<<endl;
			  if (DsvpvDistance[icand]/DsvpvDisErr[icand]>dls[ipt]&&Dchi2cl[icand]>vertexpro[ipt]&&Dalpha[icand]<alpha[ipt]&&fabs(Dy[icand])<1&&fabs(Dtrk1Y[icand])<1.2&&fabs(Dtrk2Y[icand])<1.2&&fabs(Dtrk3Y[icand])<1.2&&Dgen[icand]==23333)
			  {
	...
	TFile *result = new TFile("recoeffi_kstar_ppcuts_TMVAcuts_fun1_downup_cent.root","RECREATE");
