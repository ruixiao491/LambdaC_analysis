...
/*
c1->SaveAs("5_6pplatestTMVAcuts_MC_2gaus_1means_halfbinwidth.gif");
//h_whole_withcuts_sig->Write();
//output->Close();

TFile* result = new TFile("pp5_6_2gaus_1mean_halfbinwidth.root", "RECREATE");
h_whole_withcuts_sig->Write();
f1->Write();
f2->Write();
f3->Write();
