...
void sys_lambdac_D0_PbPb(){
	//TFile *f1 = TFile::Open("");  
	//TH1* hptspectra_sys_lambdaC = (TH1*)f1->Get("");
    double ppTrackingEfficiency_lambdaC = 14;////here I have not get the value of this variable.
	double ppTrackingEfficiency_D0 = 10;
	...
	hmassfit_sys_lambdaC->SetBinContent(1,0);
	hmassfit_sys_lambdaC->SetBinContent(2,0);
	hmassfit_sys_lambdaC->SetBinContent(3,0);
	hmassfit_sys_lambdaC->SetBinContent(4,1.7);

	hcuteffi_sys_lambdaC->SetBinContent(1,0);
	hcuteffi_sys_lambdaC->SetBinContent(2,0);
	hcuteffi_sys_lambdaC->SetBinContent(3,0);
	hcuteffi_sys_lambdaC->SetBinContent(4,6);

	hptspectra_sys_lambdaC->SetBinContent(1,0);
	hptspectra_sys_lambdaC->SetBinContent(2,0);
	hptspectra_sys_lambdaC->SetBinContent(3,0);
	hptspectra_sys_lambdaC->SetBinContent(4,5);

	hmassfit_sys_D0->SetBinContent(1,0);
	hmassfit_sys_D0->SetBinContent(2,0);
	hmassfit_sys_D0->SetBinContent(3,0);
	hmassfit_sys_D0->SetBinContent(4,6.5);

	hptspectra_sys_D0->SetBinContent(1,0);
	hptspectra_sys_D0->SetBinContent(2,0);
	hptspectra_sys_D0->SetBinContent(3,0);
	hptspectra_sys_D0->SetBinContent(4,1);

	hcuteffi_sys_D0->SetBinContent(1,0);
	hcuteffi_sys_D0->SetBinContent(2,0);
	hcuteffi_sys_D0->SetBinContent(3,0);
	hcuteffi_sys_D0->SetBinContent(4,3.5);
...
////here I did not take the track efficiency into account.	
	hsys_sum->Draw();
	TFile *result = new TFile("ratio_lambdaCD0_withsys_PbPb.root","RECREATE");
	hsys_sum->Write();
	result->Close();
}
